...
- Dekker pull requesten en og bare en endring? Hvis ikke, vurder å spålitte opp PR-en i flere.
...
* Før du tar en ny oppgave - vær HELT sikker på at du ikke kommer videre med den/se du jobber på allerede.
